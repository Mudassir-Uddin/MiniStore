...
<head>
  ...
  <!-- Font Awesome CSS -->
  <link rel="stylesheet" href="{{url('/website/assets/css/vendor/font.awesome.min.css')}}">
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
          ...
          <div class="row d-flex flex-wrap justify-content-between">
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu">
                <img src="{{url('/website/images/main-logo.png')}}" alt="logo">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="Shipping d-flex">
            ...
            <div class="card-wrap ps-2">
              <img src="{{url('/website/images/dhl.png')}}" alt="visa">
              <img src="{{url('/website/images/shippingcard.png')}}" alt="mastercard">
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
          <div class="payment-method d-flex">
            <p>Payment options:</p>
            <div class="card-wrap ps-2">
              <img src="{{url('/website/images/visa.jpg')}}" alt="visa">
              <img src="{{url('/website/images/mastercard.jpg')}}" alt="mastercard">
              <img src="{{url('/website/images/paypal.jpg')}}" alt="paypal">
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6">
          <div class="copyright">
            <p>© Copyright 2023 MiniStore. Design by <a href="https://mudassir-uddin.netlify.app/">Mudassir Uddin</a>
              Distribution by <a href="https://www.youtube.com/@CodeRunnerSolution">Code Runner</a>
            </p>
          </div>
        </div>
      </div>
  ...
  <script src="{{url('/website/js/jquery-1.11.0.min.js')}}"></script>
  <script src="https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js"></script>
  <script type="text/javascript" src="{{url('/website/js/bootstrap.bundle.min.js')}}"></script>
  <script type="text/javascript" src="{{url('/website/js/plugins.js')}}"></script>
